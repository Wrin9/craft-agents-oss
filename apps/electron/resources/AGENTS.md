...
This folder contains assets that are bundled with the Electron app and synced to the user's `~/.cody-agent/` directory on every launch.
...
|-------------|-----------|---------------|
| `docs/` | `~/.cody-agent/docs/` | Always overwrite on launch |
| `themes/` | `~/.cody-agent/themes/` | Always overwrite on launch |
| `permissions/` | `~/.cody-agent/permissions/` | Always overwrite on launch |
| `tool-icons/` | `~/.cody-agent/tool-icons/` | Always overwrite on launch |
| `release-notes/` | `~/.cody-agent/release-notes/` | Always overwrite on launch |
| `config-defaults.json` | `~/.cody-agent/config-defaults.json` | Always overwrite on launch |
