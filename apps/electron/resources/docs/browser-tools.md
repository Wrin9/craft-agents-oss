...
Use `browser_tool` to control built-in browser windows (Chromium) inside Cody Agents.
...
- Before first browser tool usage, the agent must read this guide (`~/.cody-agent/docs/browser-tools.md`).
