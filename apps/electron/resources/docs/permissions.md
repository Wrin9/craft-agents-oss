...
> **CLI-first workflow (recommended):** Use `cody-agent permission ...` commands instead of editing JSON directly.
> - `cody-agent permission --help`
...
- Source: `~/.cody-agent/workspaces/{slug}/sources/{source}/permissions.json`
