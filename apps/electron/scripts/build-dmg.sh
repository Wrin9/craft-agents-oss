...
echo "=== Building Cody Agent DMG (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder.yml uses artifactName to output: Cody-Agent-${arch}.dmg
DMG_NAME="Cody-Agent-${ARCH}.dmg"
