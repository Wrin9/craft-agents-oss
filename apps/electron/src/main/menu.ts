 ...
 * Includes only relevant items for the Cody Agent app.
 *
 ...
 *
 * On Windows/Linux: Menu is hidden - all functionality is in the Cody logo menu.
...
export async function rebuildMenu(): Promise<void> {
  ...
  // Users access menu via the Cody logo dropdown in the app
  if (!isMac) {
