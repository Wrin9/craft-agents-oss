 ...
 * Shows both default patterns (from ~/.cody-agent/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.cody-agent/permissions/default.json.
...
/**
 * Build default permissions data from ~/.cody-agent/permissions/default.json.
