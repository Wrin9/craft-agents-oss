...
function InputContainerPlayground({
  disabled = false,
  isProcessing = false,
  placeholder = 'Message Cody Agent...',
  currentModel = 'claude-sonnet-4-6',
  permissionMode = 'ask',
  workingDirectory = '/Users/demo/projects/cody-agent',
  inputMode = 'freeform',
  compactMode = false,
  ...
  React.useEffect(() => {
    ...
    const timer = setTimeout(() => {
      window.dispatchEvent(new CustomEvent('cody:paste-files', {
        detail: {
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        defaultValue: 'Message Cody Agent...',
      },
      {
        name: 'currentModel',
      ...
      },
      {
        ...
        defaultValue: '/Users/demo/projects/cody-agent',
      },
      {
        name: 'seedRecentDirs',
