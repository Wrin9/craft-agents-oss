 ...
 * with contextual understanding of valid Cody MCP URL patterns.
 */
...
const SYSTEM_PROMPT = `You are a URL validator for Cody MCP servers. Your ONLY job is to validate if a URL is a valid Cody MCP URL.
