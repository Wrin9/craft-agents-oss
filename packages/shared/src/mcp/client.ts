...
const BLOCKED_ENV_VARS = [
  // Cody Agent auth (set by the app itself)
  'ANTHROPIC_API_KEY',
 ...
 * Both CodyMcpClient (remote MCP sources) and ApiSourcePoolClient (API sources) implement this.
 */
