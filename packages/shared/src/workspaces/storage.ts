 ...
 * Default location: ~/.cody-agent/workspaces/
 */
...
import { CONFIG_DIR as SHARED_CONFIG_DIR } from '../config/paths.ts';
import type {
  WorkspaceConfig,
...
const CONFIG_DIR = SHARED_CONFIG_DIR;
...
/**
 * Get the default workspaces directory (~/.cody-agent/workspaces/)
 */
 ...
 * @param baseDir - Parent directory where workspace folders live (e.g., ~/.cody-agent/workspaces/)
 ...
 * Returns paths to valid workspaces found in ~/.cody-agent/workspaces/
 */
