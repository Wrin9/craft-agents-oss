 ...
 *
 * Watched paths:
 * - ~/.cody-agent/config.json - Main app configuration
 * - ~/.cody-agent/preferences.json - User preferences
 * - ~/.cody-agent/theme.json - App-level theme overrides
 * - ~/.cody-agent/themes/*.json - Preset theme files (app-level)
 * - ~/.cody-agent/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.cody-agent/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.cody-agent/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.cody-agent/permissions/)
