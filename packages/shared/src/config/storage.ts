...
const FALLBACK_CONFIG_DEFAULTS: ConfigDefaults = {
  version: '1.0',
  description: 'Default configuration values for Cody Agent',
  defaults: {
...
/**
 * Load config defaults from ~/.cody-agent/config-defaults.json
...
export function ensureConfigDir(): void {
  ...
  // Initialize bundled docs (creates ~/.cody-agent/docs/ with sources.md, agents.md, permissions.md)
  initializeDocs();
...
/**
 * Get the path to the app-level theme override file (~/.cody-agent/theme.json).
 */
 ...
 * Preset themes are stored at ~/.cody-agent/themes/
 */
...
/**
 * Returns the path to the tool-icons directory: ~/.cody-agent/tool-icons/
 */
