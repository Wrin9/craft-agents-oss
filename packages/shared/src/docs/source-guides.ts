 ...
 * Guides are now served exclusively via the cody-agent-docs MCP server.
 *
 ...
 * Use the cody-agent-docs MCP server to search for setup guides.
 *
 * Example: mcp__cody-agent-docs__SearchCodyAgentDocs({ query: "github source setup guide" })
 */
