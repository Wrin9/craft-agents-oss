 ...
 * Cody Agent's AgentEvent format for UI compatibility.
 *
...
/**
 * Maps Pi SDK events to Cody AgentEvents for UI compatibility.
 *
 * Event mapping:
...
export class PiEventAdapter extends BaseEventAdapter {
  ...
  /**
   * Adapt a Pi SDK event to zero or more Cody AgentEvents.
   */
